public final class Player1 extends Playable {
	public enum StoreType {
		...
		public static StoreType findById(int id) { // Offline trade
	...
	public enum PunishLevel {
		...
		PunishLevel(int value, String str) {
			val = value;
			name = str;
		}
		
		public int getPunishValue() { // Value
			return val;
		}
		
		public String getPunishName() { // String
			return name;
		}
	}
	...
	private static final int DEATH_PENALTY_SKILL_ID = 5076;
	...
	private int deathPenaltyBuffLevel;
	...
	private Player1 _activeRequester;
	...
	private Player1 _summonTargetRequest;
	private L2Skill _summonSkillRequest;
	private Door _requestedGate;
	
	private boolean _isEXPDisabled; /** Start: menu commands */
	...
	private boolean _isTradeDisabled; /** End: menu commands */

	/**
	 * Constructor of Player1 (use Creature constructor).
	 * Call the Creature constructor to create an empty _skills slot and copy basic Calculator set to this Player1
	 * Set the name of the Player1
	 * This method SET the level of the Player1 to 1
	 * @param objectId Identifier of the object to initialized
	 * @param template The PlayerTemplate to apply to the Player1
	 * @param accountName The name of the account including this Player1
	 * @param app The PcAppearance of the Player1
	 */
	private Player1(int objectId, PlayerTemplate template, String accountName, PcAppearance app) {
		...
		getInventory().restore(); // Retrieve from the database all items of this Player1 and add them to _inventory
		getWarehouse();
		getFreight();
	}
	
	private Player1(int objectId) {
		super(objectId, null);
		initCharStatusUpdateValues();
	}
	
	/**
	 * Create a new Player1 and add it in the characters table of the database.
	 * Create a new Player1 with an account name
	 * Set the name, the Hair Style, the Hair Color and the Face type of the Player1
	 * Add the player in the characters table of the database
	 * @param objectId Identifier of the object to initialized
	 * @param template The PlayerTemplate to apply to the Player1
	 * @param accountName The name of the Player1
	 * @param name The name of the Player1
	 * @param hairStyle The hair style Identifier of the Player1
	 * @param hairColor The hair color Identifier of the Player1
	 * @param face The face type Identifier of the Player1
	 * @param sex The sex type Identifier of the Player1
	 * @return The Player1 added to the database or null
	 */
	public static Player1 create(int objectId, PlayerTemplate template, String accountName, String name, byte hairStyle, byte hairColor, byte face, Sex sex) {
		PcAppearance playerAppearance = new PcAppearance(face, hairColor, hairStyle, sex);
		Player1 player = new Player1(objectId, template, accountName, playerAppearance);
		player.setName(name);
	...
	/**
	 * @return the base PlayerTemplate link to the Player1.
	 */
	...
	/**
	 * @return the PlayerTemplate link to the Player1.
	 */
	@Override
	...
	/**
	 * @return the AI of the Player1 (create it if necessary).
	 */
	@Override
	...
	/**
	 * A newbie is a player reaching level 1. He isn't considered newbie at lvl 20.<br>
	...
	/**
	 * @return a table containing all Common RecipeList of the Player1.
	 */
	...
	/**
	 * @return a table containing all Dwarf RecipeList of the Player1.
	 */
	...
	/**
	 * Add a new L2RecipList to the table _commonrecipebook containing all RecipeList of the Player1.
	...
	/**
	 * Add a new L2RecipList to the table _recipebook containing all RecipeList of the Player1.
	 * @param recipe The RecipeList to add to the _recipebook
	 */
	...
	/**
	 * Tries to remove a {@link Recipe} from this {@link Player1}. Delete the associated {@link L2ShortCut}, if existing.
	...
	/**
	 * Add a QuestState to the table _quest containing all quests began by the Player1.
	...
	/**
	 * Remove a QuestState from the table _quest containing all quests began by the Player1.
	...
	/**
	 * Add QuestState instance that is to be notified of Player1's death.
	...
	/**
	 * Remove QuestState instance that is to be notified of Player1's death.
	 * @param qs The QuestState that subscribe to this event
	 */
	...
	/**
	 * @return A list of QuestStates which registered for notify of death of this Player1.
	 */
	...
	/**
	 * @return A table containing all L2ShortCut of the Player1.
	 */
	 ...
	 * @return The L2ShortCut of the Player1 corresponding to the position (page-slot).
	 */
	...
	/**
	 * Add a L2shortCut to the Player1 _shortCuts
	...
	/**
	 * Delete the L2ShortCut corresponding to the position (page-slot) from the Player1 _shortCuts.
	 * @param slot
	 * @param page
	 */
	...
	/**
	 * Add a L2Macro to the Player1 _macroses.
	...
	/**
	 * Delete the L2Macro corresponding to the Identifier from the Player1 _macroses.
	 * @param id
	 */
	...
	/**
	 * @return all L2Macro of the Player1.
	 */
	...
	/**
	 * Set the siege state of the Player1.
	...
	/**
	 * @return the siege state of the Player1.
	 */
	...
	/**
	 * Set the PvP Flag of the Player1.
	...
	public int getRelation(Player1 target) {
		int result = 0;
	...
	/**
	 * @return the PK counter of the Player1.
	 */
	...
	/**
	 * Set the PK counter of the Player1.
	...
	/**
	 * @return The _deleteTimer of the Player1.
	 */
	...
	/**
	 * Set the _deleteTimer of the Player1.
	...
	/**
	 * @return The current weight of the Player1.
	 */
	...
	/**
	 * @return The number of recommandation obtained by the Player1.
	 */
	...
	/**
	 * Set the number of recommandations obtained by the Player1 (Max : 255).
	...
	/**
	 * Edit the number of recommandation obtained by the Player1 (Max : 255).
	...
	/**
	 * @return The number of recommandation that the Player1 can give.
	 */
	...
	/**
	 * Set the number of givable recommandations by the {@link Player1} (Max : 9).
	...
	/**
	 * Increment the number of recommandation that the Player1 can give.
	 */
	...
	public void giveRecom(Player1 target) {
	...
	public boolean canRecom(Player1 target) {
		return !_recomChars.contains(target.getObjectId());
	}
	
	/**
	 * Set the exp of the Player1 before a death
	 * @param exp
	 */
	...
	/**
	 * Return the Karma of the Player1.
	 */
	@Override
	public int getKarma() {
		return _karma;
	...
	/**
	 * Set the Karma of the Player1 and send StatusUpdate (broadcast).
	 * @param karma A value.
	 */
	...
	/**
	 * @return The max weight that the Player1 can load.
	 */
	...
	/**
	 * @return PvP Kills of the Player1 (number of player killed during a PvP).
	 */
	...
	/**
	 * Set PvP Kills of the Player1 (number of player killed during a PvP).
	...
	/**
	 * @return The ClassId object of the Player1 contained in PlayerTemplate.
	 */
	...
	/**
	 * @return The String of the Player1 class name from PlayerTemplate.
	 */
	...
	/**
	 * Set the template of the Player1.
	 * @param Id The Identifier of the PlayerTemplate to set to the Player1
	 */
	public void setClassId(int Id) {
		...
		try {
			...
			if (academyLevel != 0 && _clan != null && ClassId.VALUES[Id].level() >= 1) {
				...
				addItem("Gift", 8181, 1, this, true); // receive graduation gift : academy circlet
			}
			...
			if (_party != null) // Update class icon in party and clan
	...
	/**
	 * @return the Experience of the Player1.
	 */
	public long getExp() {
	...
	/**
	 * @return The Race object of the Player1.
	 */
	...
	/**
	 * @return the SP amount of the Player1.
	 */
	public int getSp() {
	 ...
	 * @return True if this Player1 is a clan leader in ownership of the passed castle.
	 */
	...
	/**
	 * @return The Clan Identifier of the Player1.
	 */
	...
	/**
	 * @return The Clan Crest Identifier of the Player1 or 0.
	 */
	...
	/**
	 * Return the PcInventory Inventory of the Player1 contained in _inventory.
	 */
	@Override
	...
	/**
	 * Delete a ShortCut of the Player1 _shortCuts.
	...
	/**
	 * @return True if the Player1 is sitting.
	 */
	...
	/**
	 * Sit down the Player1, set the AI Intention to REST and send ChangeWaitType packet (broadcast)
	 */
	public void sitDown() {
		sitDown(true);
	}
	...
	/**
	 * Stand up the Player1, set the AI Intention to IDLE and send ChangeWaitType packet (broadcast)
	 */
	public void standUp() {
	...
	public void tryToSitOrStand(final WorldObject target, final boolean sittingState) {
		...
		if (isThrone && !sittingState && !isInsideRadius(target, Npc.INTERACTION_DISTANCE, false, false)) { // Player1 wants to sit on a throne but is out of radius, move to the throne delaying the sit action.
		...
		if (!isMoving()) { // Player1 isn't moving, sit directly.
			if (getMountType() != 0)
				return;
			...
			NextAction nextAction = new NextAction(CtrlEvent.EVT_ARRIVED, CtrlIntention.MOVE_TO, () -> nextActionSit(target, sittingState, isThrone)); // Player1 is moving, wait the current action is done, then sit.
			getAI().setNextAction(nextAction); // Binding next action to AI.
		}
	}
	...
	/**
	 * @return The PcWarehouse object of the Player1.
	 */
	...
	/**
	 * @return The PcFreight object of the Player1.
	 */
	...
	/**
	 * @return The Adena amount of the Player1.
	 */
	public int getAdena() {
	...
	/**
	 * @return The Ancient Adena amount of the Player1.
	 */
	...
	/**
	 * Add adena to Inventory of the Player1 and send InventoryUpdate packet to the Player1.
	...
	/**
	 * Reduce adena in Inventory of the Player1 and send InventoryUpdate packet to the Player1.
	 * @param process String Identifier of process triggering this action
	...
	/**
	 * Add ancient adena to Inventory of the Player1 and send InventoryUpdate packet to the Player1.
	 * @param process String Identifier of process triggering this action
	...
	/**
	 * Reduce ancient adena in Inventory of the Player1 and send InventoryUpdate packet to the Player1.
	 * @param process String Identifier of process triggering this action
	...
	/**
	 * Adds item to inventory and send InventoryUpdate packet to the Player1.
	 * @param process String Identifier of process triggering this action
	...
	public void checkArrowOrCursedUpdRuneShadow(ItemInstance newitem, ItemType type) {
		...
		/*else if (type == EtcItemType.ARROW && getAttackType() == WeaponType.BOW && _inventory.getPaperdollItem(Inventory.PAPERDOLL_LHAND) == null) // If you pickup arrows and a bow is equipped, try to equip them if no arrows is currently equipped.
			checkAndEquipArrows();*/
	}
	
	public void addItems(int... itemIds) {
		for (int item : itemIds)
			addItem("Gift", item, 1, this, true);
	}

	/**
	 * Destroy item from inventory and send InventoryUpdate packet to the Player1.
	 * @param process String Identifier of process triggering this action
	...
	/**
	 * Destroys item from inventory and send InventoryUpdate packet to the Player1.
	 * @param process String Identifier of process triggering this action
	...
	/**
	 * Destroys shots from inventory without logging and only occasional saving to database. Sends InventoryUpdate packet to the Player1.
	 * @param process String Identifier of process triggering this action
	 * @param objectId int Item Instance identifier of the item to be destroyed
	 * @param count int Quantity of items to be destroyed
	 * @param reference WorldObject Object referencing current action like NPC selling item or previous item in transformation
	...
	/**
	 * Destroy item from inventory by using its <B>itemId</B> and send InventoryUpdate packet to the Player1.
	 * @param process String Identifier of process triggering this action
	...
	public void statusUpdate(Player1 player, int id, int level) {
	...
	/**
	 * Transfers item to another ItemContainer and send InventoryUpdate packet to the Player1.
	 * @param process String Identifier of process triggering this action
	...
	public ItemInstance transferItem(String process, int objectId, int count, Inventory target, WorldObject reference) {
		...
		if (target instanceof PcInventory) { // Send target update packet
			final Player1 targetPlayer = ((PcInventory) target).getOwner();
	...
	/**
	 * Drop item from inventory and send InventoryUpdate packet to the Player1.
	 * @param process String Identifier of process triggering this action
	...
	/**
	 * Drop item from inventory by using its <B>objectID</B> and send InventoryUpdate packet to the Player1.
	 * @param process String Identifier of process triggering this action
	...
	/**
	 * Close the active connection with the {@link L2GameClient} linked to this {@link Player1}.
	...
	/**
	 * @see com.sf.glory.gameserver.model.actor.Creature#enableSkill(com.sf.glory.gameserver.model.L2Skill)
	 */
	@Override
	...
	@Override
	public void onAction(Player1 player) {
		...
		if (player.getTarget() != this) { // Set the target of the player
			...
			if (isInStoreMode()) { // Check if this Player1 has a Private Store
				player.getAI().setIntention(CtrlIntention.INTERACT, this);
				return;
			}
			
			if (isAutoAttackable(player)) { // Check if this Player1 is autoAttackable
				if ((isCursedWeaponEquipped() && player.levelLessThan(21)) || (player.isCursedWeaponEquipped() && levelLessThan(21))) { // Player1 with lvl < 21 can't attack a cursed weapon holder and a cursed weapon holder can't attack players with lvl < 21
	...
	@Override
	public void onActionShift(Player1 player) {
		if (player.isGM())
	...
	/**
	 * Send packet StatusUpdate with current HP,MP and CP to the Player1 and only current HP, MP and Level to all other Player1 of the Party.
	 * Send StatusUpdate with current HP, MP and CP to this Player1
	 * Send PartySmallWindowUpdate with current HP, MP and Level to all other Player1 of the Party
	 * This method DOESN'T SEND current HP and MP to all Player1 of the _statusListener
	 */
	@Override
	public void broadcastStatusUpdate() {
		StatusUpdate su = new StatusUpdate(this); // Send StatusUpdate with current HP, MP and CP to this Player1
		...
		if (_party != null && (needCpUpdate || needHpUpdate || needMpUpdate(352))) // Check if a party is in progress and party window update is needed.
	 ...
	 * Send a UserInfo packet (public and private data) to this Player1.
	 * Send a CharInfo packet (public data only) to Player1's knownlist.
	 */
	...
	public final void broadcastCharInfo() {
		for (Player1 player : getKnownType(Player1.class)) {
	...
	/**
	 * @return the Alliance Identifier of the Player1.
	 */
	...
	/**
	 * Manage Interact Task with another Player1.<BR>
	 ...
	 * Send a System Message to the Player1 : YOU_PICKED_UP_S1_ADENA or YOU_PICKED_UP_S1_S2
	 * Add the Item to the Player1 inventory
	 * Send InventoryUpdate to this Player1 with NewItem (use a new slot) or ModifiedItem (increase amount)
	 * Send StatusUpdate to this Player1 with current weight
	...
	public void setTarget(WorldObject newTarget) {
		...
		if (newTargetIsPlayer && getTarget() == null && !hasKarma() && !isFlagged() && !isSameFaction(((Player1) newTarget)) && !((Player1) newTarget).isInsideZone(ZoneId.PEACE)) // disable auto target
			newTarget = this;
		...
		if (oldTarget != null) {
			...
			if (oldTarget instanceof Creature) // Remove the Player1 from the _statusListener of the old target if it was a Creature
		...
		} else if (newTarget instanceof Creature) { // Add the Player1 to the _statusListener of the new target if it's a Creature
	...
	public boolean isSameFaction(Player1 target) {
	...
	public void engageAnswer(int answer) {
		...
		final Player1 requester = World.getInstance().getPlayer(_requesterId);
	 ...
	 * Reduce the Experience of the Player1 in function of the calculated Death Penalty
	 * If necessary, unsummon the Pet of the killed Player1
	 * Manage Karma gain for attacker and Karma loss for the killed Player1
	 * If the killed Player1 has Karma, manage Drop Item
	 * Kill the Player1
	 * @param killer The Creature who attacks
	 */
	@Override
	public boolean doDie(Creature killer) {
		if (!super.doDie(killer)) // Kill the Player1
			return false;
		...
		boolean playerMinLevel = isMinLevel();
		
		if (playerMinLevel && !inDungeon && !EventBase.isStartedAndParticipant(playerObjectId) && !isInOlympiadMode() && isNotInSiegeAndSiegeStateIsZero() && !isInsideSiegeOrPvPZone()) {
			setPunishLevel(PunishLevel.DEAD, 5);
			penaltyDeadPlayer(this, getName(), true);
		}

		if (EventBase.isStartedAndParticipant(playerObjectId))
			EventBase.getEventInstance(eventInstance -> eventInstance.onKill(killer, this));
	
		if (inDungeon)
			getDungeon().onPlayerDeath(this);
		
		if (killer != null) {
			Player1 pk = killer.getActingPlayer();
			boolean isPlayer = killer.isInstanceOfPlayer();

			if (isPlayer)
				killerPlayerOnDie(killer, pk, playerObjectId, playerMinLevel);

			handleCursedWeaponOnDie(pk, killer);
			onDieDropItem(pk, killer, isPlayer); // Check if any item should be dropped
		...
		calculateDeathPenaltyLevel(killer); // calculate death penalty buff
		WaterTaskManager.getInstance().remove(this);

		if (isPhoenixBlessed() || (isAffected(L2EffectFlag.CHARM_OF_COURAGE) && isInSiege()))
			reviveRequest(this, null, false);

		updateEffectIcons(); // Icons update in order to get retained buffs list
		return true;
	}
	
	public void handleCursedWeaponOnDie(Player1 pk, Creature killer) {
		...
		if (pk == null || !pk.isCursedWeaponEquipped()) {
			if (!isInArena()) { // if the area isn't an arena
				if (pk != null && pk.getClan() != null && getClan() != null && !isAcademyMember() && !pk.isAcademyMember()) { // if both victim and attacker got clans & aren't academicians
					if (_clan.isAtWarWith(pk.getClanId()) && pk.getClan().isAtWarWith(_clan.getClanId())) { // if clans got mutual war, then use the reputation calcul
						if (getClan().getReputationScore() > 0)
							pk.getClan().addReputationScore(1); // when your reputation score is 0 or below, the other clan cannot acquire any reputation points

						if (pk.getClan().getReputationScore() > 0)
							_clan.takeReputationScore(1); // when the opposing sides reputation score is 0 or below, your clans reputation score doesn't decrease
					}
				}
			}
			
			applyDeathExperienceLoss(); // Reduce player's xp and karma.
		}
	}
	
	public void killerPlayerOnDie(Creature killer, Player1 pk, int playerObjectId, boolean playerMinLevel) {
		if (!isInsideZone(ZoneId.PVP) && !killer.isInsideZone(ZoneId.PVP) && killer != this) {
			if (pvpActivityBlock) {
				KILLED_PLAYERS.put(pk.getObjectId(), playerObjectId);
				TIME_TO_NEXT_KILL.put(pk.getObjectId(), System.currentTimeMillis());
				blockPvPActivity();
				...
				if (playerMinLevel) {
					...
					if (!isPvPCounterReady(pk, false))
						bonusForDeath(killer, false, (hasKarma() || isFlagged()) ? Rnd.get(killer.getLevel() > getLevel() ? getLevel() : 1, killer.getLevel()) : getRecomHave() / 10);
				}
	...
	public boolean isNotInSiegeAndSiegeStateIsZero() {
		return !isInSiege() && getSiegeState() == 0;
	}

	public static final int[][] ANTI_DROP_VALUES = {
		{ 1, 8, 7, 6, 5 },
		{ 1, 7, 6, 5, 4 },
		{ 1, 6, 5, 4, 3 },
		{ 1, 5, 4, 3, 2 },
	...
	private void onDieDropItem(Player1 pk, Creature killer, boolean isPlayer) {
		if (isPlayer) {
			Clan pkClan = pk.getClan();

			if (!hasKarma() && pkClan != null && getClan() != null && pkClan.isAtWarWith(getClanId()))
				return;
		}

		if (hasExactVipLevel(3))
			return;

		if (isInsideSiegeOrPvPZone() || getPkKills() < Config.KARMA_PK_LIMIT)
			return;

		if (hasKarma()) {
			handleDropItems(killer, Config.KARMA_DROP_LIMIT, Config.KARMA_RATE_DROP, Config.KARMA_RATE_DROP_ITEM, Config.KARMA_RATE_DROP_EQUIP, Config.KARMA_RATE_DROP_EQUIP_WEAPON);
		} else if (hasSkill(L2Skill.ANTI_DROP)) {
			int skillLevel = getSkillLevel(L2Skill.ANTI_DROP) - 1;
			handleDropItems(killer, ANTI_DROP_VALUES[skillLevel][0], ANTI_DROP_VALUES[skillLevel][1], ANTI_DROP_VALUES[skillLevel][2], ANTI_DROP_VALUES[skillLevel][3], ANTI_DROP_VALUES[skillLevel][4]);
		} else {
			handleDropItems(killer, Config.PLAYER_DROP_LIMIT, Config.PLAYER_RATE_DROP, Config.PLAYER_RATE_DROP_ITEM, Config.PLAYER_RATE_DROP_EQUIP, Config.PLAYER_RATE_DROP_EQUIP_WEAPON);
		}
	}
	
	private void handleDropItems(Creature killer, int dropLimit, int dropPercent, int dropItem, int dropEquip, int dropEquipWeapon) {
		if (dropPercent > 0 && Rnd.isLessThanRandom(dropPercent)) {
			...
			for (ItemInstance itemDrop : getInventory().getItems()) {
				...
				if (!itemDrop.isDropable() || itemId == ClassMaster.GOLD_ITEM_ID || item.getType2() == Item.TYPE2_QUEST || pet != null && pet.getControlItemId() == itemId || 
					binarySearch(Config.KARMA_LIST_NONDROPPABLE_ITEMS, itemId) || binarySearch(Config.KARMA_LIST_NONDROPPABLE_PET_ITEMS, itemId))
					continue;
	...
	public static boolean binarySearch(int[] array, int itemId) {
		return Arrays.binarySearch(array, itemId) >= 0;
	}
	...
	private void setPvPActivityBlock(boolean pvpActivityBlock) {
		this.pvpActivityBlock = pvpActivityBlock;
	}
	
	private boolean killingSpreeTimer = true;
	
	private void setKillingSpreeTimer(boolean killingSpreeTimer) {
		this.killingSpreeTimer = killingSpreeTimer;
	}
	...
	/*private void spreeCounterMsg() {
		...
		//	this.sendPacket(cs);
		//Broadcast.announceToOnlinePlayers(cs); Broadcast.toAllOnlinePlayers(cs);
		this.sendMessage("Killing Spree is over. Kills back to: " + killingSpreeKills);
	}*/
...
//		sendMessage("PvP Protection is ON! PvP reward blocked for " + Config.PVP_BLOCK_REWARD_TIME + " sec.");
	...
	private void spreeCounter() {
		if (killingSpreeKills < 6) {
			killingSpreeKills++;
			
			/*CreatureSay cs = new CreatureSay(getObjectId(), Say2.ALL, getName(), "Kills " + killingSpreeKills);
				sendPacket(cs);
				
			if (killingSpreeKills == 2)
				sendMessage("You have " + Config.KILLING_SPREE_TIME + " sec to finish Killing Spree. Kills now: " + killingSpreeKills);*/
		}
...
//				spreeCounterMsg();
	...
	private void spreeReward() {
		for (SpreeKills spreeKills : SpreeKillsData.getInstance().getSpreeKills()) {
			int spKills = spreeKills.getKills();
			
			if (spKills == killingSpreeKills) {
				...
				if (spreeKills.getItemId() > 0)
					addItem("Reward", spreeKills.getItemId(), spreeKills.getItemCount(), null, true);

				progressAchievement(AchievementType.STREAK);
			}

			if (spKills == 5 && spKills == killingSpreeKills)
				Broadcast.announceToOnlinePlayers("Player1 <" + getName() + "> performed Penta Kill!", true);
		}
	}
	...
	public void onKillUpdatePvPKarma(Playable target) {
		final Player1 targetPlayer = target.getActingPlayer();
		...
		if (Config.SAME_PARTY_REWARD_BLOCK) {
			if (getParty() != null && targetPlayer.getParty() != null && getParty().equals(targetPlayer.getParty())) {
		...
		boolean targetIsAPlayer = target.isInstanceOfPlayer();

		if (isCursedWeaponEquipped() && targetIsAPlayer) {
		...
		if (isInsideZone(ZoneId.PVP) && targetPlayer.isInsideZone(ZoneId.PVP)) {
			...
			if (targetIsAPlayer && playerState > 0 && targetState > 0 && playerState != targetState) {
				if (playerClan != null)
					playerClan.setSiegeKills(playerClan.getSiegeKills() + 1);
				...
				if (isMinLevel()) {
					...
					if (!isPvPCounterReady(targetPlayer, true)) {
						if (isSameFaction(targetPlayer) && !targetPlayer.hasKarma() && !targetPlayer.isFlagged()) {
							...
							updateDeathPenalty();
							setKarma(_karma + Formulas.calculateKarmaGain(getPkKills(), false, playerLevel));
							handleProgression(this, AchievementType.PK, QuestIdType.PK);
						}

						if (checkLevelsRange(playerLevel, targetPlayer.getLevel()))
	...
	private void updateDeathPenalty() {
		if (deathPenaltyBuffLevel != 0)
			removeSkill(DEATH_PENALTY_SKILL_ID, false);

		deathPenaltyBuffLevel++;
		addTemporarySkill(DEATH_PENALTY_SKILL_ID, deathPenaltyBuffLevel);
		sendPacket(new EtcStatusUpdate(this));
		sendPacket(SystemMessage.getSystemMessage(SystemMessageId.DEATH_PENALTY_LEVEL_S1_ADDED).addNumber(deathPenaltyBuffLevel));
	}
	
	private boolean isPvPCounterReady(Player1 targetOrKiller, boolean onKill) {
	...
	private void bonusForKill(Player1 target, boolean recLeft, int bonus) {
	...
	public void updatePvPStatus(Creature targetPlayer) {
		final Player1 target = targetPlayer.getActingPlayer();
	...
	/**
	 * Restore the experience this Player1 has lost and sends StatusUpdate packet.
	...
	/**
	 * Applies the experience (and, if necessary, level) loss that occurs when this
	 * player dies. Nothing happens if the death took place inside a siege or PvP zone,
	 * or if the server is configured to disable de-levelling.
	 */
	...
	/**
	 * Return the L2Summon of the Player1 or null.
	 */
	@Override
	...
	/**
	 * Set the L2Summon of the Player1.
	...
	/**
	 * @return the L2TamedBeast of the Player1 or null.
	 */
	...
	/**
	 * Set the L2TamedBeast of the Player1.
	...
	/**
	 * Set the Player1 requester of a transaction (ex : FriendInvite, JoinAlly, JoinParty...).
	 * @param requester
	 */
	public void setActiveRequester(Player1 requester) {
		_activeRequester = requester;
	}
	
	/**
	 * @return the Player1 requester of a transaction (ex : FriendInvite, JoinAlly, JoinParty...).
	 */
	public Player1 getActiveRequester() {
	...
	/**
	 * Set the _requestExpireTime of that Player1, and set his partner as the active requester.
	 * @param partner The partner to make checks on.
	 */
	public void onTransactionRequest(Player1 partner) {
	...
	public void onTradeStart(Player1 partner) {
	...
	public void onTradeConfirm(Player1 partner) {
	...
	public void onTradeCancel(Player1 partner) {
	...
	public void startTrade(Player1 partner) {
	...
	public void cancelActiveTrade() {
		...
		Player1 partner = _activeTradeList.getPartner();
	...
	/**
	 * Set the Store type of the Player1.
	 ...
	 * Reward the {@link Player1} with autoGet skills only, or if Config.AUTO_LEARN_SKILLS is activated, with all available skills.
	 */
	 ...
	 * Reward the {@link Player1} with all available skills, being autoGet or general skills.
	 */
	...
	/**
	 * Delete all invalid {@link L2Skill}s for this {@link Player1}.<br>
	...
	private void removeInvalidSkills() {
		...
		for (L2Skill skill : getSkills().values()) {
			...
			if (skill.getLevel() > maxLevel) { // Case of enchanted skills.
				if ((playerLevel < 76 || availableSkill.getValue() < maxLevel) && skill.getLevel() > availableSkill.getValue()) // Player1 level is inferior to 76, or available skill is a good candidate.
	...
	public void regiveTemporarySkills() {
		...
		if (clan != null) {
			clan.addSkillEffects(this); // Add Clan Skills.
			
			if (clan.getLevel() >= Config.MINIMUM_CLAN_LEVEL && isClanLeader())
				addSiegeSkills();
		}
	...
	/**
	 * @return a {@link List} of all available autoGet {@link GeneralSkillNode}s <b>of maximal level</b> for this {@link Player1}.
	 */
	...
	/**
	 * @return a {@link List} of available {@link GeneralSkillNode}s (only general) for this {@link Player1}.
	 */
	...
	/**
	 * @return a {@link List} of all available {@link GeneralSkillNode}s (being general or autoGet) <b>of maximal level</b> for this {@link Player1}.
	 */
	 ...
	 * @return the required level for next {@link GeneralSkillNode} to learn for this {@link Player1}.
	 */
	...
	protected boolean checkAndEquipArrows() {
		final ItemInstance arrows = getInventory().findArrowForBow(getActiveWeaponItem()); // Retrieve arrows instance on player inventory.
		
		if (arrows == null)
			return false;

		if (arrows.getLocation() == ItemLocation.PAPERDOLL) // Arrows are already equiped, don't bother.
			return true;

		getInventory().setPaperdollItem(Inventory.PAPERDOLL_LHAND, arrows); // Equip arrows in left hand.
		sendPacket(new ItemList(this, false)); // Send ItemList to this player to update left hand equipement
		return true;
	}*/
	...
	protected class FeedTask implements Runnable {
		...
		public void run() {
			...
			if (food != null && checkFoodState(_petTemplate.getAutoFeedLimit())) {
				...
				if (handler != null) {
					handler.useItem(Player1.this, food, false);
	...
	/**
	 * Return True if the Player1 is invulnerable.
	 */
	@Override
	...
	/**
	 * Return True if the Player1 has a Party in progress.
	 */
	@Override
	...
	/**
	 * Set the _party object of the Player1 (without joining it).
	...
	/**
	 * Return the _party object of the Player1.
	 */
	@Override
	...
	/**
	 * Return True if the Player1 is a GM.
	 */
	@Override
	public boolean isGM() {
	...
	/**
	 * Set the {@link AccessLevel} of this {@link Player1}.
	...
	/**
	 * @return the _accessLevel of the Player1.
	 */
	...
	/**
	 * Update Stats of the Player1 client side by sending UserInfo/StatusUpdate to this Player1 and CharInfo/StatusUpdate to all Player1 in its _KnownPlayers (broadcast).
	 * @param broadcastType
	 */
	...
	/**
	 * Send StatusUpdate packet with Karma to the Player1 and all Player1 to inform (broadcast).
	 */
	...
	/**
	 * Update the characters table of the database with online status and lastAccess of this Player1 (called when login and logout).
	 */
	...
	/** TODO: refactor?
	 * Retrieve a Player1 from the characters table of the database.
	 * Retrieve the Player1 from the characters table of the database
	 * Set the x,y,z position of the Player1 and make it invisible
	 * Update the overloaded status of the Player1
	 * @param objectId Identifier of the object to initialized
	 * @return The Player1 loaded from the database
	 */
	public static Player1 restore(int objectId) {
		Player1 player = null;
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			while (rset.next()) {
				...
				player = new Player1(objectId, template, rset.getString("account_name"), app);
				...
				player.getPosition().set(rset.getInt("x"), rset.getInt("y"), rset.getInt("z")); // Set the x,y,z position of the Player1 and make it invisible
				...
				// Retrieve from the database all secondary data of this Player1 and reward expertise/lucky skills if necessary. Note that Clan, Noblesse and Hero skills are given separately and not here.
	...
	/**
	 * Restores sub-class data for the Player1, used to check the current class index for the character.
	 * @param player The player to make checks on.
	 * @return true if successful.
	 */
	private static boolean restoreSubClassData(Player1 player) {
		try (Connection con = L2DatabaseFactory.getInstance().getConnection();
	...
	/**
	 * Restores secondary data for the Player1, based on the current class index.
	 */
	private void restoreCharData() {
		restoreSkills(); // Retrieve from the database all skills of this Player1 and add them to _skills.
		_macroses.restore(); // Retrieve from the database all macroses of this Player1 and add them to _macroses.
		_shortCuts.restore(); // Retrieve from the database all shortCuts of this Player1 and add them to _shortCuts.
		restoreHenna(); // Retrieve from the database all henna of this Player1 and add them to _henna.
		restoreRecom(); // Retrieve from the database all recom data of this Player1 and add to _recomChars.

		if (!isSubClassActive())
			restoreRecipeBook(); // Retrieve from the database the recipe book of this Player1.
	}
	
	/**
	 * Store {@link Recipe} book data for this {@link Player1}, if he isn't on an active subclass.
	 */
	...
	/**
	 * Restore {@link Recipe} book data for this {@link Player1}.
	 */
	...
	/**
	 * Update Player1 stats in the characters table of the database.
	...
	private void storeCharBase() {
		...
		questManagerDefault.storeQuests();
		questManagerGlobal.storeQuests();
		questManagerBattle.storeQuests();
		counterManager.storeCounters();
	...
	/**
	 * @return True if the Player1 is online.
	 */
	...
	/**
	 * Add a {@link L2Skill} and its Func objects to the calculator set of the {@link Player1}.<BR>
	...
	/**
	 * Remove a {@link L2Skill} from this {@link Player1}. If parameter store is true, we also remove it from database and update shortcuts.
	...
	/**
	 * Insert or update a {@link Player1} skill in the database.<br>
	...
	/**
	 * Restore all skills from database for this {@link Player1} and feed getSkills().
	 */
	...
	/**
	 * Retrieve from the database all skill effects of this Player1 and add them to the player.
	 */
	...
	/**
	 * Retrieve from the database all Henna of this Player1, add them to _henna and calculate stats of the Player1.
	 */
	private void restoreHenna() {
		...
		recalcHennaStats(); // Calculate Henna modifiers of this Player1
	}
	
	/**
	 * Retrieve from the database all Recommendation data of this Player1, add to _recomChars and calculate stats of the Player1.
	 */
	...
	/**
	 * @return the number of {@link Henna} empty slots of this {@link Player1}.
	 */
	...
	/**
	 * Remove an {@link Henna} of this {@link Player1}, save it to the database and send packets to refresh client.
	...
	public boolean removeHenna(int slot) {
		...
		recalcHennaStats(); // Calculate Henna modifiers of this Player1
		refreshHennaList(); // Send HennaInfo packet to this Player1
		sendUserInfo(); // Send UserInfo packet to this Player1
		reduceAdena("Henna", Constant.NUMBER_1000, this, false); // henna.getPrice() / 5
		addItem("Henna", henna.getDyeId(), Constant.NUMBER_1, this, true);// Add the recovered dyes to the player's inventory and notify them. // Henna.getRequiredDyeAmount() / 2
		sendPacket(SystemMessageId.SYMBOL_DELETED);
		return true;
	}
	
	/**
	 * Add a {@link Henna} to this {@link Player1}, save it to the database and send packets to refresh client.
	...
	/**
	 * Recalculate {@link Henna} modifiers of this {@link Player1}.
	 */
	 ...
	 * @return the {@link Henna} of this {@link Player1} corresponding to the selected slot.
	 */
	...
	/**
	 * Return True if the Player1 is autoAttackable.
	 * Check if the attacker isn't the Player1 Pet
	 * Check if the attacker is L2MonsterInstance
	 * If the attacker is a Player1, check if it is not in the same party
	 * Check if the Player1 has Karma
	 * If the attacker is a Player1, check if it is not in the same siege clan (Attacker, Defender)
	 */
	@Override
	public boolean isAutoAttackable(Creature attacker) {
		...
		if (attacker instanceof Playable) {
			...
			final Player1 attackerPlayer = attacker.getActingPlayer();
			...
			if (clan != null) {
				if (siege != null) {
					if (siege.checkSides(attackerPlayer.getClan(), SiegeSide.DEFENDER, SiegeSide.OWNER) && siege.checkSides(clan, SiegeSide.DEFENDER, SiegeSide.OWNER)) // Check if a siege is in progress and if attacker and the Player1 aren't in the Defender clan.
						return false;

					if (siege.checkSide(attackerPlayer.getClan(), SiegeSide.ATTACKER) && siege.checkSide(clan, SiegeSide.ATTACKER)) // Check if a siege is in progress and if attacker and the Player1 aren't in the Attacker clan.
						return false;
				}
		...
		if (attacker instanceof SiegeGuard)
			return getClan() != null && siege != null && siege.checkSide(getClan(), SiegeSide.ATTACKER);
	...
	private boolean checkUseMagicConditions(L2Skill skill, boolean forceUse, boolean dontMove) {
		...
		if ((target instanceof Door && (!((Door) target).isAutoAttackable(this) || (((Door) target).isUnlockable() && sklType != L2SkillType.UNLOCK))) ||  // Siege Doors Only Hittable During Siege or Unlockable Doors.
			(isInDuel() && target instanceof Playable && target.getActingPlayer().getDuelId() != getDuelId()) ||  // Are the Target and the Player1 in the Same Duel.
			(target.isInstanceOfPlayer() && ((Player1) target).isAlikeDead()) ||
	...
	private WorldObject getSkillTarget(SkillTargetType sklTargetType, Location worldPosition) {
		...
		switch (sklTargetType) { // Target the Player1 if Skill Type is AURA, PARTY, CLAN or SELF.
			case TARGET_AURA:
			case TARGET_FRONT_AURA:
			case TARGET_BEHIND_AURA:
			case TARGET_AURA_UNDEAD:
	...
	private boolean canTargetInPvp(L2Skill skill, WorldObject target, SkillTargetType sklTargetType) {
		switch (sklTargetType) { // Check if This is a PvP Skill and Target Isn't a Non-Flagged or Non-Karma Player1.
			case TARGET_PARTY:
	...
	private void sendTargetError() { // sendErrorPackets
		sendPacket(SystemMessageId.INCORRECT_TARGET); // Send a System Message to the Player1
		sendPacket(ActionFailed.STATIC_PACKET); // Send ActionFailed to the Player1
	}
	...
	public boolean isLooterOrInLooterParty(int objectId) {
		...
		final Player1 looter = World.getInstance().getPlayer(objectId);
	...
	public boolean checkPvpSkill(WorldObject target, L2Skill skill) {
		...
		if (isInParty() && targetPlayer.isInParty())
			if (getParty().getLeader() == targetPlayer.getParty().getLeader() || (getParty().getCommandChannel() != null && getParty().getCommandChannel().containsPlayer(targetPlayer)))
	...
	/**
	 * @return True if the Player1 is a Mage (based on class templates).
	 */
	...
	/**
	 * Send UserInfo to this Player1 and CharInfo to all Player1 in its _KnownPlayers.<BR>
	 * Send UserInfo to this Player1 (Public and Private Data)
	 * Send CharInfo to all Player1 in _KnownPlayers of the Player1 (Public data only)
	...
	/**
	 * Add a L2CubicInstance to the Player1 _cubics.
	 * @param id
	 * @param level
	 * @param matk
	...
	/**
	 * Remove a L2CubicInstance from the Player1 _cubics.
	 * @param id
	 */
	...
	/**
	 * @param id
	 * @return the L2CubicInstance corresponding to the Identifier of the Player1 _cubics.
	 */
	...
	/**
	 * Remember the current {@link Folk} of the {@link Player1}, used notably for integrity check.
	...
	/**
	 * @return the current {@link Folk} of the {@link Player1}.
	 */
	...
	public void rechargeShots(boolean physical, boolean magic) {
		...
		for (int itemId : _activeSoulShots) {
			...
			if (item != null) {
				rechargeShots(magic, ActionType.spiritshot);
				rechargeShots(physical, ActionType.soulshot);
			} else {
	...
	private void rechargeShots(boolean condition, ActionType actionType) {
	...
	private void setClassTemplate(int classId) {
		...
		setTemplate(PlayerData.getInstance().getTemplate(classId)); // Set the template of the Player1
	}
	...
	public void doRevive() {
		...
		if (getPunishLevel() == PunishLevel.DEAD && getPunishTimer() > 0) {
			...
			penaltyDeadPlayer(this, this.getName(), false);
			stopPunishTask(true);
		}
	...
	public void reviveRequest(Player1 reviver, L2Skill skill, boolean pet) {
	...
	public VipStats getVipData() {
		return VipSystem.getVIPData(vipLevel);
	}
	...
	/**
	 * Manage the delete task of a Player1 (Leave Party, Unsummon pet, Save its inventory in the database, Remove it from the world...).
	 * If the Player1 is in observer mode, set its position to its position before entering in observer mode
	 ...
	 * Remove the Player1 from the world
	...
	private synchronized void cleanup() {
		try {
			...
			if (isMounted())
				...
				getPet().unSummon(this); // If the Player1 has a summon, unsummon it.

			// Stop all scheduled tasks.
			stopHpMpRegeneration();
			stopPunishTask(true);
			stopChargeTask();
			// Stop all timers associated to that Player1.
			WaterTaskManager.getInstance().remove(this);
			...
			// If the Player1 is a GM, remove it from the GM List
			if (isGM())
				AdminData.getInstance().deleteGm(this);

			// Check if the Player1 is in observer mode to set its position to its position before entering in observer mode
			if (isInObserverMode())
	...
	public int getInventoryLimit() {
		return (isDwarfRace() ? Config.INVENTORY_MAXIMUM_DWARF : Config.INVENTORY_MAXIMUM_NO_DWARF) + (int) getStat().calcStat(Stats.INV_LIM, 0, null, null);
	}
	...
	public int getWareHouseLimit() {
		return (isDwarfRace() ? Config.WAREHOUSE_SLOTS_DWARF : Config.WAREHOUSE_SLOTS_NO_DWARF) + (int) getStat().calcStat(Stats.WH_LIM, 0, null, null);
	}
	
	public int getPrivateSellStoreLimit() {
		return (isDwarfRace() ? Config.MAX_PVTSTORE_SLOTS_DWARF : Config.MAX_PVTSTORE_SLOTS_OTHER) + (int) getStat().calcStat(Stats.P_SELL_LIM, 0, null, null);
	}
	
	public int getPrivateBuyStoreLimit() {
		return (isDwarfRace() ? Config.MAX_PVTSTORE_SLOTS_DWARF : Config.MAX_PVTSTORE_SLOTS_OTHER) + (int) getStat().calcStat(Stats.P_BUY_LIM, 0, null, null);
	}
	...
	/**
	 * This method is overidden on Player1, L2Summon and L2Npc.
	...
	private void updatePunishState() {
		if (getPunishLevel() != PunishLevel.NONE) {
			...
			if (getPunishLevel() == PunishLevel.JAIL && !isInsideZone(ZoneId.JAIL))  // If Player1 Escaped, Put Him Back in Jail.
				teleToLocation(Location.JAIL);
		}
	}
	...
	private boolean hasDeathPenaltyBuff() {
		return deathPenaltyBuffLevel > 0;
	}
	
	public void calculateDeathPenaltyLevel(Creature killer) {
		if (deathPenaltyBuffLevel >= 15 || killer.isInstanceOfPlayer() || isInsideSiegeZone() || isPhoenixBlessed() || (getCharmOfLuck() && (killer == null || killer.isRaidRelated())))
			return;
	...
	@Override
	public Player1 getActingPlayer() {
		return this;
	}
	...
	public final void sendDamageMessage(Creature target, int damage, boolean mcrit, boolean pcrit, boolean miss) {
		...
		if (isInOlympiadMode() && target.isInstanceOfPlayer() && ((Player1) target).isInOlympiadMode() && ((Player1) target).getOlympiadGameId() == getOlympiadGameId())
	...
	public void checkItemRestriction() {
		for (ItemInstance equippedItem : getInventory().getPaperdollItems()) {
			...
			useEquippableItem(equippedItem, equippedItem.isInstWeapon());
		}
	}
	...
	/**
	 * @return the number of charges this Player1 got.
	 */
	...
	public boolean canAttackCharacter(Creature cha) {
		...
		final Player1 target = cha.getActingPlayer();
	...
	/**
	 * Teleport the current {@link Player1} to the destination of another player.<br>
	 * <br>
	 ...
	 */
	public void teleportToFriend(Player1 player, L2Skill skill) {
	...
	/**
	 * Test if the current {@link Player1} can summon. Send back messages if he can't.
	...
	public boolean isTargetSummonable(WorldObject target) {
		...
		final Player1 player = (Player1) target;
	...
	private void notifyFriends(boolean login) {
		for (int id : _friendList) {
			Player1 friend = World.getInstance().getPlayer(id);
	...
	@Override
	public void sendInfo(Player1 activeChar) {
		if (isInBoat())
	...
	public boolean teleportRequest(Player1 requester, L2Skill skill) {
	...
	public void removeKnownObject(WorldObject object) {
		...
		sendPacket(new DeleteObject(object, (object.isInstanceOfPlayer()) && ((Player1) object).isSeated())); // send Server-Client Packet DeleteObject to the Player1
	}
	
	public final void refreshInfos() {
		for (WorldObject object : getKnownType(WorldObject.class)) {
			if (object.isInstanceOfPlayer() && ((Player1) object).isInObserverMode())
				continue;
	...
	private final void sendInfoFrom(WorldObject object) {
		if (object.getPolyType() == PolyType.ITEM) {
			...
			if (object instanceof Creature) {
				Creature obj = (Creature) object; // Update the state of the Creature object client side by sending Server->Client packet MoveToPawn/MoveToLocation and AutoAttackStart to the Player1
	...
	/**SIEGEDAMAGE START*/
	private int[] siegeDamage = { 0, 0, 0 }; // 0 - Outpost, 1 - Artifact, 2 - Town

	public int getSiegeDamage(int type) {
		return siegeDamage[type];
	}

	public void setSiegeDamage(int type, int damage) {
		siegeDamage[type] = damage;
	}
	...
	/**ACHIEVEMENTS STAGES START*/
	private AchievementProgress achievementProgress = new AchievementProgress(this);
	
	public final AchievementProgress getAchievementProgress() {
		return achievementProgress;
	}
	/**ACHIEVEMENTS STAGES END*/

	/**VIP START*/
	private int vipLevel;
	public static final int[] VIP_SKILLS = { 7098, 7099, 485, 486, 487, 488, 489 };
	
	public void setVipLevel(int level) {
		vipLevel = vipLevelClamp(level);

		for (int skill : VIP_SKILLS) {
			if (vipLevel > 0 && (vipLevel == 3 || skill > 489))
				addTemporarySkill(skill, vipLevel);
			else
	...
	public void extendStatus(SpecialStatusType type, int val) {
		statusAction(type, val, "You extended " + type + " status for the next 7 days.", specialStatusManager.getExpireTime(type));
	}
	
	private void statusAction(SpecialStatusType type, int val, String msg, long time) {
		sendMessage(msg);
		specialStatusManager.store(type, String.valueOf(val), time + ClassMaster.daysToMillis(ClassMaster.DAYS));
	}
	/**VIP END*/
...
//	public SkinItemArmor getSkinArmor() {
//		return (SkinItemArmor) _skins[0];
//	}
//	
//	public SkinItemWeapon getSkinWeapon() {
//		return (SkinItemWeapon) _skins[1];
//	}
	...
	/*private Skinable[] _skins = new Skinable[2];
	
	public Skinable getSkinArmor() {
		return _skins[0];
	}
	
	public void setSkinArmor(SkinItemArmor skinArmor) {
		_skins[0] = skinArmor;
	}
	
	public Skinable getSkinWeapon() {
		return _skins[1];
	}
	
	public void setSkinWeapon(SkinItemWeapon skinWeapon) {
		_skins[1] = skinWeapon;
	}
	...
	/*private SkinItemArmor _skinArmor;
	private SkinItemWeapon _skinWeapon;
	...
	public void setSkinWeapon(SkinItemWeapon skinWeapon) {
		_skinWeapon = skinWeapon;
	}
	
	public void setSkin(Skinable skin) {
		if (skin instanceof SkinItemArmor)
			_skinArmor = (SkinItemArmor) skin;
		else
			_skinWeapon = (SkinItemWeapon) skin;
	}*/
	/**SKINS END*/
	...
	public void penaltyDeadPlayer(Player1 activeChar, String name, boolean ban) {
		try (Connection con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement ps = con.prepareStatement(UPDATE_BAN)) {
			ps.setInt(1, ban ? PunishLevel.DEAD.getPunishValue() : PunishLevel.NONE.getPunishValue()); // level
			ps.setLong(2, ban ? 300000 : 0); // value
			ps.setString(3, name);
			ps.execute();
		} catch (Exception e) {
			e.printStackTrace();
	...
	/**DAILY WEEKLY TASK START*/
	private QuestManagerDefault questManagerDefault = new QuestManagerDefault(this);
	
	public QuestManagerDefault getQuestManagerDefault() {
		return questManagerDefault;
	}
	
	private QuestManagerGlobal questManagerGlobal = new QuestManagerGlobal(this);
	
	public QuestManagerGlobal getQuestManagerGlobal() {
		return questManagerGlobal;
	}
	
	private QuestManagerBattle questManagerBattle = new QuestManagerBattle(this);;
	
	public QuestManagerBattle getQuestManagerBattle() {
		return questManagerBattle;
	}
	
	private CounterManager counterManager = new CounterManager(this);
	
	public CounterManager getCounterManager() {
		if (isBeforeNoon())
			counterManager.updateCountersTime();

		return counterManager;
	}
	
	public static boolean isBeforeNoon() {
		return LocalTime.now().isAfter(LocalTime.MIDNIGHT) && LocalTime.now().isBefore(LocalTime.NOON);
	}
	
	private SpecialStatusManager specialStatusManager = new SpecialStatusManager(this);
	
	public SpecialStatusManager getSpecialStatusManager() {
		return specialStatusManager;
	}
	
	private static void taskLoader(Player1 player) {
	...
	/**DAILY WEEKLY TASK END*/

	public static boolean isValidFaction(int factionId) {
		return factionId >= Constant.GOD && factionId <= Constant.TITAN;
	}
	
	public boolean verifyVipAndPlayerLevel(int vipLevel, int playerLevel) {
		return verifyPlayerVipLevel(vipLevel, false) && verifyPlayerLevel(playerLevel, false);
	}
	...
	private void addSkillsForGroup(Player1 player, int startBossId, int endBossId, int startSkillId, SiegeManager[] managers) {
	...
	public static final int[][] START_END_BOSS_IDS_GODS = {
		{ 5000, 5018, 5400 }, 
		{ 5100, 5107, 5500 }, 
		{ 5200, 5205, 5600 }
	};
	
	public static final int[][] START_END_BOSS_IDS_GIANTS = {
		{ 6000, 6018, 5400 }, 
		{ 6100, 6107, 5500 }, 
		{ 6200, 6205, 5600 },
	};
	
	public static final int[][] START_END_BOSS_IDS_TITANS = {
		{ 7000, 7018, 5400 }, 
		{ 7100, 7107, 5500 }, 
		{ 7200, 7205, 5600 }
	};
	...
	private void assignSiegeHalfAllSkills(Player1 player, SiegeManager[] managers) {
	...
	private void addSiegeSkill(Player1 player, int status, int skillId, String skillMessage, SiegeManager manager) {
	...
	public static void handleProgression(Creature killer, AchievementType type, QuestIdType idType) {
		...
		Player1 player = killer.getActingPlayer();
	...
	private QuestManagerAbstract playerQuestManager;
	...
	public void setPlayerQuestManager(QuestManagerAbstract questManagerAbstract) {
		playerQuestManager = questManagerAbstract;
	}
	...
	public static void setIsParalyzedDelayedMsg(Player1 player, boolean start, int skId, int delay, String msg) {
	...
	public static void setIsParalyzedStart(Player1 player, int delay) {
